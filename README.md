# Recommendation Engines with IBM Watson

In this project, the user interactions with articles on the IBM Watson Studio platform have to be analyzed. Afterwards recommendations have to be made for new articles that the users probably like.
...
# Acknowledgements
Project was given from Udacity, Data has been provided by IBM.
